...
>
> The OpenAPI specification is generated automatically from [TwindApi](https://github.com/twind-ops/TwindApi) ([#2219](https://github.com/twind-ops/TwindApi/pull/2219) publishes it to this repo as **`openapi-public-api.yaml`**). Any manual changes will be overwritten on the next deployment. **`index.html`** loads that file for the interactive reference.
...
├── openapi-public-api.yaml         # OpenAPI spec (auto-generated by TwindApi CI)
├── README.md                       # This file
└── guides/
